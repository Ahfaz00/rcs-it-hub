...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "refurbished laptop buying guide, ddr3 vs ddr4, bulk ram deals, wholesale it hardware guide" },
      { property: "og:url", content: "https://rcs-it-hub.lovable.app/blog" },
    ],
    links: [{ rel: "canonical", href: "https://rcs-it-hub.lovable.app/blog" }],
  }),
