...
export const Route = createFileRoute("/collections/")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "refurbished laptop deals, budget laptops india, best refurbished laptop collection" },
      { property: "og:url", content: "https://rcs-it-hub.lovable.app/collections" },
    ],
    links: [{ rel: "canonical", href: "https://rcs-it-hub.lovable.app/collections" }],
  }),
